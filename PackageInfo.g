...
##  one line.
Subtitle := "alexander - Simplicial Homology and Cohomology",
...
PackageDoc := rec(
  ...
  LongTitle := "alexander - Simplicial Homology and Cohomology",
...
Dependencies := rec(
  ...
  NeededOtherPackages := [["GAPDoc", ">= 1.1"], ["homalg", ">= 2008.08.05"]],
