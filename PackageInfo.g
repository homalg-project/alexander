#############################################################################
##  
##  PackageInfo.g for the package `alexander'                Mohamed Barakat
##
...
#
PackageName := "alexander",

##  This may be used by a default banner or on a Web page, should fit on
##  one line.
Subtitle := "Simplicial Homology and Cohomology",

##  See '?Extending: Version Numbers' in GAP help for an explanation
##  of valid version numbers. For an automatic package distribution update
##  you must provide a new version number even after small changes.
Version := "2011.06.28.16:00",
...
PackageDoc := rec(
  ...
  LongTitle := "Simplicial Homology and Cohomology",
...
Dependencies := rec(
  ...
  NeededOtherPackages := [ [ "MatricesForHomalg", ">= 2011.06.28.16:00" ], [ "Modules", ">= 2011.04.16" ], [ "GAPDoc", ">= 1.1" ] ],
...
BannerString := Concatenation( 
  "----------------------------------------------------------------\n",
  "Loading  alexander ", ~.Version, "\n",
  "by ", ~.Persons[1].FirstNames, " ", ~.Persons[1].LastName,
        " (", ~.Persons[1].WWWHome, ")\n",
  "For help, type: ?alexander package \n",
  "----------------------------------------------------------------\n" ),
